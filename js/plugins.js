...
$(document).ready(function() {
    ...
    $("#skills").appear(function() {
		...
		$("#chart_num_13").animateNumber({
            number: 81
        }, 1500);
		$("#chart_num_14").animateNumber({
            number: 73
        }, 1500);
		$("#chart_num_15").animateNumber({
            number: 91
        }, 1500);
		$("#chart_num_16").animateNumber({
            number: 88
        }, 1500);
    }, {
        accX: 0,
...
function init() {
    ...
    var mapOptions = {
        ...
        center: new google.maps.LatLng(43.000354, -81.278120),
    ...
    var marker = new google.maps.Marker({
        position: new google.maps.LatLng(43.000354, -81.278120),
    ...
    var infowindow = new google.maps.InfoWindow({
        content: "Ontario Hall, Western University"
    });
